...
class RoutingDecision(BaseModel):
    ...
    intent: Literal["lookup", "learning", "personal", "social", "off_topic", "web_search"] = Field(
        default="lookup",
        description="Query intent: lookup=tra cứu, learning=học/giải thích/quiz, personal=ngữ cảnh cá nhân, social=chào hỏi/cảm ơn, off_topic=không liên quan domain, web_search=tìm kiếm web/tin tức/pháp luật"
    )
    agent: Literal["RAG_AGENT", "TUTOR_AGENT", "MEMORY_AGENT", "DIRECT"] = Field(
