...
- Latest benchmark evidence: `embedding-retrieval-benchmark-2026-04-02-214300.json`
...
- Query embedding: `4921.56 ms`, ok=`True`
- Document embedding: `140.94 ms`, ok=`True`
- Semantic context: `206.75 ms`, memories=`1`, facts=`1`
- Hybrid search: `480.89 ms`, results=`2`, method=`hybrid`
- Observations: provider_promoted_to_ollama

### openai_large_768

- Active backend: `openai / text-embedding-3-large / 768d`
- Query embedding: `655.12 ms`, ok=`False`
- Document embedding: `100.89 ms`, ok=`False`
- Semantic context: `108.46 ms`, memories=`1`, facts=`1`
- Hybrid search: `105.10 ms`, results=`2`, method=`sparse_only`
- Observations: query_embedding_failed_or_empty, document_embedding_failed_or_empty
