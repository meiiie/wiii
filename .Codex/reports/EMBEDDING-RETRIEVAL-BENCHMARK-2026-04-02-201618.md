...
- Generated at: `2026-04-02T20:16:18.661617`
...
- Raw query embed: `2085.31 ms` (0 dims, ok=False)
- Raw document embed: `103.14 ms` (768 dims, ok=True)
- Semantic context: `87.94 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `425.44 ms`, results=2, knowledge_embeddings=2, method=hybrid
...
- Active embedding backend: `google/models/gemini-embedding-001` `768d`
- Raw query embed: `1110.41 ms` (0 dims, ok=False)
- Raw document embed: `112.04 ms` (768 dims, ok=True)
- Semantic context: `121.69 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `86.29 ms`, results=2, knowledge_embeddings=2, method=hybrid
