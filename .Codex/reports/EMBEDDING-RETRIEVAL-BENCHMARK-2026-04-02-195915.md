...
- Generated at: `2026-04-02T19:59:15.242829`
...
- Raw query embed: `2452.62 ms` (0 dims, ok=False)
- Raw document embed: `158.45 ms` (768 dims, ok=True)
- Semantic context: `158.62 ms`, memories=0, facts=1, tokens=2, threshold=0.3
- Hybrid search: `459.66 ms`, results=2, knowledge_embeddings=2, method=hybrid
...
- Raw query embed: `1590.07 ms` (768 dims, ok=True)
- Raw document embed: `145.49 ms` (768 dims, ok=True)
- Semantic context: `188.49 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `142.46 ms`, results=2, knowledge_embeddings=2, method=hybrid
