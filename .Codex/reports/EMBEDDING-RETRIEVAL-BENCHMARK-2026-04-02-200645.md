...
- Generated at: `2026-04-02T20:06:45.445782`
...
- Raw query embed: `2416.44 ms` (0 dims, ok=False)
- Raw document embed: `89.07 ms` (768 dims, ok=True)
- Semantic context: `96.18 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `446.36 ms`, results=2, knowledge_embeddings=2, method=hybrid
...
- Active embedding backend: `google/models/gemini-embedding-001` `768d`
- Raw query embed: `945.55 ms` (0 dims, ok=False)
- Raw document embed: `91.4 ms` (768 dims, ok=True)
- Semantic context: `95.73 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `108.46 ms`, results=2, knowledge_embeddings=2, method=hybrid
