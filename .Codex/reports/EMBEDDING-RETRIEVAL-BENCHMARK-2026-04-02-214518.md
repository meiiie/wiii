...
- Generated at: `2026-04-02T21:45:18.576486`
...
- Raw query embed: `1729.33 ms` (768 dims, ok=True)
- Raw document embed: `134.81 ms` (768 dims, ok=True)
- Semantic context: `191.52 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `492.99 ms`, results=2, knowledge_embeddings=2, method=hybrid
