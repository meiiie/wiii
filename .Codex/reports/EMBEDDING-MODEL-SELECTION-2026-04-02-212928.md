...
- Latest benchmark evidence: `embedding-retrieval-benchmark-2026-04-02-212719.json`
...
- Measured query embed latency: `492.72 ms`
...
- Measured query embed latency: `3449.53 ms`
- Measured hybrid search latency: `184.84 ms`
- Sources:
...
- Measured query embed latency: `5657.25 ms`
- Measured hybrid search latency: `488.46 ms`
- Sources:
...
- Query embedding: `3449.53 ms`, ok=`True`
- Document embedding: `156.05 ms`, ok=`True`
- Semantic context: `236.87 ms`, memories=`1`, facts=`1`
- Hybrid search: `184.84 ms`, results=`2`, method=`hybrid`
- Observations: provider_promoted_to_openai

### ollama_local_first

- Active backend: `ollama / embeddinggemma / 768d`
- Query embedding: `5657.25 ms`, ok=`True`
- Document embedding: `148.39 ms`, ok=`True`
- Semantic context: `210.77 ms`, memories=`1`, facts=`1`
- Hybrid search: `488.46 ms`, results=`2`, method=`hybrid`

### openai_large_768

- Active backend: `openai / text-embedding-3-large / 768d`
- Query embedding: `492.72 ms`, ok=`True`
- Document embedding: `297.12 ms`, ok=`True`
- Semantic context: `269.61 ms`, memories=`1`, facts=`1`
