...
- Generated at: `2026-04-02T21:43:00.873126`
...
- Raw query embed: `4921.56 ms` (768 dims, ok=True)
- Raw document embed: `140.94 ms` (768 dims, ok=True)
- Semantic context: `206.75 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `480.89 ms`, results=2, knowledge_embeddings=2, method=hybrid
...
- Raw query embed: `655.12 ms` (0 dims, ok=False)
- Raw document embed: `100.89 ms` (0 dims, ok=False)
- Semantic context: `108.46 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `105.1 ms`, results=2, knowledge_embeddings=2, method=sparse_only
