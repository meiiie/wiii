...
- Generated at: `2026-04-02T20:18:11.303009`
...
- Raw query embed: `2058.66 ms` (0 dims, ok=False)
- Raw document embed: `83.58 ms` (768 dims, ok=True)
- Semantic context: `96.15 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `370.95 ms`, results=2, knowledge_embeddings=2, method=sparse_only
...
- Active embedding backend: `google/models/gemini-embedding-001` `768d`
- Raw query embed: `817.05 ms` (0 dims, ok=False)
- Raw document embed: `77.91 ms` (768 dims, ok=True)
- Semantic context: `122.22 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `97.35 ms`, results=2, knowledge_embeddings=2, method=sparse_only
