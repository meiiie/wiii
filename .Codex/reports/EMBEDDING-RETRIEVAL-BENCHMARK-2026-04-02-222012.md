...
- Generated at: `2026-04-02T22:20:12.449924`
...
- Raw query embed: `3931.94 ms` (768 dims, ok=True)
- Raw document embed: `277.81 ms` (768 dims, ok=True)
- Semantic context: `307.42 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `628.9 ms`, results=2, knowledge_embeddings=2, method=hybrid

Snapshot:
- `google` -> blocked:space_mismatch, model=`None`, active=False
- `openai` -> blocked:missing_api_key, model=`None`, active=False
- `openrouter` -> blocked:missing_api_key, model=`None`, active=False
- `ollama` -> usable, model=`embeddinggemma`, active=True
- `zhipu` -> blocked:space_mismatch, model=`None`, active=False
