...
- Generated at: `2026-04-02T21:43:29.310353`
...
- Raw query embed: `4836.69 ms` (768 dims, ok=True)
- Raw document embed: `851.53 ms` (768 dims, ok=True)
- Semantic context: `223.77 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `496.99 ms`, results=2, knowledge_embeddings=2, method=hybrid
...
- Raw query embed: `564.65 ms` (768 dims, ok=True)
- Raw document embed: `264.14 ms` (768 dims, ok=True)
- Semantic context: `358.04 ms`, memories=1, facts=1, tokens=36, threshold=0.3
- Hybrid search: `175.9 ms`, results=2, knowledge_embeddings=2, method=hybrid
